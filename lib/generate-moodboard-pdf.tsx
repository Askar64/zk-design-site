...
const styles = StyleSheet.create({
  page: { backgroundColor: "#0a0a0a", padding: 32 },
  header: {
    flexDirection: "row",
  ...
  studioName: { fontSize: 18, color: "#ffffff", fontFamily: "Helvetica-Bold" },
  clientName: { fontSize: 11, color: "#ffffff", fontFamily: "Helvetica" },
  clientMeta: { fontSize: 9, color: "#666666", fontFamily: "Helvetica", marginTop: 2 },
  tagRow: { flexDirection: "row", flexWrap: "wrap", gap: 5, marginBottom: 16 },
  tag: {
    backgroundColor: "#1a1a1a", color: "#aaaaaa", fontSize: 8,
    paddingVertical: 3, paddingHorizontal: 8, borderRadius: 20, fontFamily: "Helvetica",
  },
  ...
  footerText: { fontSize: 8, color: "#444444", fontFamily: "Helvetica" },
});
